...
let gameRuns = false; // why is this a let, not a const, false & true are booleans
...
const determineWinner = (choiceC, choiceP = DEFAULT_CHOICE_USER) => 
    ...
    // if (choiceC === choiceP) {
    //     return RESULT_DRAW;
    // } else if (choiceC === SELECT_ROCK && choiceP === SELECT_PAPER || 
    //     choiceC === SELECT_PAPER && choiceP === SELECT_SCISSORS || 
    //     choiceC === SELECT_SCISSORS && choiceP === SELECT_ROCK) {
...
startGameBtn.addEventListener('click', () => {
    if (gameRuns) { // why do we need this and what does the return do here?
        return;
    }
    gameRuns = true;
